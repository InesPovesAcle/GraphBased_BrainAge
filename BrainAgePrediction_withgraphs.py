...
CKPT_DIR = os.path.join(OUT_DIR, "cv_checkpoints")
...
torch.save(
    graph_data_list_addecode,
    os.path.join(OUT_DIR, "graph_data_list_addecode.pt")
)
        ...
        for epoch in range(epochs):
            ...
            if test_loss < best_loss:
                ...
                ckpt_path = os.path.join(
                    CKPT_DIR,
                    f"model_fold_{fold+1}_rep_{repeat+1}.pt"
                    )
...
torch.save(
    ...
    os.path.join(OUT_DIR, "model_trained_on_all_healthy.pt")
)
