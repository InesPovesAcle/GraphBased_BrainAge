...
# ---------------------------  CONFIG  ---------------------------
OUT_DIR = os.path.join(os.environ["WORK"], "ines/results/BrainAgePredictionHealthy_withoutPCA")
...
final_model_path = os.path.join(OUT_DIR, "model_trained_on_all_healthy_without_PCA.pt")
