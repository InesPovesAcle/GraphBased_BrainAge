...
rd = os.path.join(
    WORK, "ines/data/Regional_stats/ADDecode/AD_Decode_studywide_stats_for_mrtrixrd.csv"
)
...
hc_rd = extract_hc_metrics(rd, "HC_RD")

for df_metric in (hc_volume, hc_volume_norm, hc_fa, hc_md, hc_rd):
